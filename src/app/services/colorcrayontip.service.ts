...
export class ColorcrayontipService {
  ...
  getQuizes() {
    ...
    return this.http.get('http://localhost:8080/api/v1/quizes',
  ...
  getQuizesForStudent(userObject) {
    ...
    return this.http.get('http://localhost:8080/api/v1/quizes/username/' + body,
      {headers: new HttpHeaders().set('Authorization', 'Bearer ' + token)}
    );
  }
  ...
  getQuiz(id: number) {
    ...
    return this.http.get('http://localhost:8080/api/v1/quizes/' + id,
        {headers: new HttpHeaders().set('Authorization', 'Bearer ' + token)}
      );
  }
  ...
  createQuizRegistration(quiz) {
    ...
    return this.http.post('http://localhost:8080/api/v1/quizes', body, httpOptions);
  }
